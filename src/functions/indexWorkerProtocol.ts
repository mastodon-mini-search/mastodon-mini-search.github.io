...
// index bundle of ArrayBuffers, or search hits, out); the live index never
// crosses the boundary (its builder Maps / typed-array views stay in the worker).
export type WorkerRequest =
  | { id: number; type: 'restore'; data: PersistedIndex }
...
// search -> hits. 'clear' gets no reply (fire-and-forget).
export type WorkerResult = boolean | PersistedIndex | SearchHit[]
